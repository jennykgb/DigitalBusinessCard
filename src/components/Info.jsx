...
function Info(){
    return(
        <div className="info">
            ...
            <a href="https://jennygiraldoportfolio.netlify.app" target="_blank">
                <p className='website'>jennygiraldoportfolio.netlify.app</p>
            </a>
            
            <a className='button email' href="mailto: jennykgb@gmail.com">
